...
import 'package:kb_bank_clone/theme/demo_shadows.dart';
...
final kCustomAppBarSize = Size.fromHeight(64.h);
  ...
  Widget build(BuildContext context) {
    return DecoratedBox(
      decoration: BoxDecoration(
        ...
        boxShadow: isScrolledUnder ? [DemoShadows.dark.shadow1] : null,
      ),
      child: SafeArea(
        bottom: false,
